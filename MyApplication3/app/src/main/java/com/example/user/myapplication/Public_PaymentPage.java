...
public class Public_PaymentPage extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadLocale();
        setContentView(R.layout.activity_public__payment_page);
    ...
    public void selectlanguage()
    {
        ...
        AlertDialog.Builder nbuilder=new AlertDialog.Builder(Public_PaymentPage.this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(IsinsertData = true)
                    Toast.makeText(Public_PaymentPage.this,"Inserted payment values",Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(Public_PaymentPage.this," not inserted",Toast.LENGTH_LONG).show();
            }
        });
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //submit.setBackgroundColor(getResources().getColor(R.color.colorPrimary));
                     ...
                     insertdata();
                    AlertDialog.Builder builder = new AlertDialog.Builder(Public_PaymentPage.this);
                    // View view;
                    view = LayoutInflater.from(Public_PaymentPage.this).inflate(R.layout.custom_layout, null);
