...
public class ViewSeats_S extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadLocale();
        setContentView(R.layout.activity_view_seats__s);
        ...
        p1=(Button)findViewById(R.id.Pymnt);
...
//                    Toast.makeText(getBaseContext(), "Button background" + clickcount, Toast.LENGTH_SHORT).show();
   ...
   /* public void payment(){
        Intent intent2 = new Intent(getApplicationContext(), Public_PaymentPage.class);
    ...
    public void selectlanguage()
    {
        ...
        AlertDialog.Builder nbuilder=new AlertDialog.Builder(ViewSeats_S.this);
    ...
    public void onButtonClick_ToPayment_sltb(View view) {
        ...
        if(IsinsertData = true)
            Toast.makeText(ViewSeats_S.this,"data inserted",Toast.LENGTH_LONG).show();
        else
            Toast.makeText(ViewSeats_S.this,"data not inserted",Toast.LENGTH_LONG).show();
        //  viewAll();
//
        Intent intent2 = new Intent(getApplicationContext(), ViewSeats_S.class);// to janani nangi's page
